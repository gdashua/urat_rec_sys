    ...
    <!--header begins here-->
        <div class="container-fluid">
          <div class="container">
            <div class="row">
              <div class="col-12">
                <!--form data will go to students info table-->
                <form action="#" class="login-form">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control rounded-left" placeholder="Admission Number" required>
                  </div> 
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control rounded-left" placeholder="Middle Name" required>
                  </div>
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary rounded submit p-3 px-5">Add Student</button>
                  </div>
                </form>
